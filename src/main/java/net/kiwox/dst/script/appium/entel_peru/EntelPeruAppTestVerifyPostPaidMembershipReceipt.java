...
public class EntelPeruAppTestVerifyPostPaidMembershipReceipt implements ITest {
    ...
    static {
        STEPS_TEST = Collections.singletonMap("Step01", new AbstractMap.SimpleEntry<>("DST-ENTEL_PERU-D010-E001", "Acceder a Recibo"));
    }
    ...
    public void verifyPostPaidMembershipReceipt(AndroidDriver<AndroidElement> driver, String contentPath) throws InterruptedException {
        ...
        try {
            ...
            testResult.addItemDetail((new TestResultDetailEntelApp().setCode("DST-ENTEL_PERU-D010-001")
