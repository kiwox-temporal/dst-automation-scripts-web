...
import net.kiwox.dst.script.appium.entel_peru.EntelPeruAppTestVerifyPostPaidBag;
import net.kiwox.dst.script.appium.entel_peru.EntelPeruAppTestVerifyPrePaidBag;
import net.kiwox.dst.script.pojo.TestResult;
import org.apache.commons.cli.Option;
import org.apache.commons.cli.Options;

public class EntelPeruAppCommandVerifyPrePaidBag extends AbstractCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			ITest test = new EntelPeruAppTestVerifyPrePaidBag(phoneNumber, verificationCode);
	...
	protected String getCommandName() {
		return "app-entel-peru-verificar-bolsa-pre-pago";
	}

	@Override
	protected String getErrorCode() {
		return "DST-MI-ENTEL-PERU-004";
	}
