...
import static net.kiwox.dst.script.appium.TestUtils.CLI_EXECUTE_VERIFY_POST_PAID_BAG_02_ENTEL_WEB_APP;
import static net.kiwox.dst.script.appium.TestUtils.CLI_EXECUTE_VERIFY_POST_PAID_BALANCE_01_ENTEL_WEB_APP;

public class EntelWebVerfiyPostPaidBalanceCommand extends AbstractChromeCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			IChromeTest test = new EntelWebVerifyPostPaidBalanceTest(phoneNumber, passCode);
	...
	protected String getCommandName() {
		return CLI_EXECUTE_VERIFY_POST_PAID_BALANCE_01_ENTEL_WEB_APP;
	}

	@Override
	protected String getErrorCode() {
		return "DST-ENTEL-WEB-001";
	}
