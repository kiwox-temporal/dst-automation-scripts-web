...
import net.kiwox.dst.script.chrome.testflows.EntelWebVerifyHistoricReceiptsPostPaidTest;
import net.kiwox.dst.script.chrome.testflows.EntelWebVerifyPostPaidBalanceTest;
...
import static net.kiwox.dst.script.appium.TestUtils.CLI_EXECUTE_VERIFY_HISTORIC_RECEIPTS_POST_PAID_04_ENTEL_WEB_APP;
import static net.kiwox.dst.script.appium.TestUtils.CLI_EXECUTE_VERIFY_POST_PAID_BALANCE_01_ENTEL_WEB_APP;

public class EntelWebVerfiyHistoricReceiptsPostPaidCommand extends AbstractChromeCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			IChromeTest test = new EntelWebVerifyHistoricReceiptsPostPaidTest(phoneNumber, passCode);
	...
	protected String getCommandName() {
		return CLI_EXECUTE_VERIFY_HISTORIC_RECEIPTS_POST_PAID_04_ENTEL_WEB_APP;
	}

	@Override
	protected String getErrorCode() {
		return "DST-ENTEL-WEB-004";
	}
