...
import net.kiwox.dst.script.appium.entel_peru.EntelPeruAppTestVerifyPostPaidBenefit;
import net.kiwox.dst.script.pojo.TestResult;
import org.apache.commons.cli.Option;
import org.apache.commons.cli.Options;

public class EntelPeruAppCommandVerifyPostPaidAdditionaLine extends AbstractCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			ITest test = new EntelPeruAppTestVerifyPostPaidAdditionalLine(phoneNumber, verificationCode);
	...
	protected String getCommandName() {
		return "app-entel-peru-verificar-beneficios-post-pago";
	}
