...
public class EntelPeruAppCommandVerifyPrePaidRecharge extends AbstractCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			ITest test = new EntelPeruAppTestVerifyPrePaidRecharge(phoneNumber, verificationCode);
	...
	protected String getCommandName() {
		return "app-entel-peru-verificar-recarga-pre-pago";
	}

	@Override
	protected String getErrorCode() {
		return "DST-MI-ENTEL-PERU-005";
	}
