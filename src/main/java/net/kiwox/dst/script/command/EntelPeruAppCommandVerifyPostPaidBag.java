...
public class EntelPeruAppCommandVerifyPostPaidBag extends AbstractCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			ITest test = new EntelPeruAppTestVerifyPostPaidBag(phoneNumber, verificationCode);
	...
	protected String getCommandName() {
		return "app-entel-peru-verificar-bolsa-post-pago";
	}
