...
import net.kiwox.dst.script.appium.entel_peru.EntelPeruAppTestVerifyPostPaidAdditionalLine;
import net.kiwox.dst.script.appium.entel_peru.EntelPeruAppTestVerifyPostPaidMembershipReceipt;
import net.kiwox.dst.script.pojo.TestResult;
import org.apache.commons.cli.Option;
import org.apache.commons.cli.Options;

public class EntelPeruAppCommandVerifyPostPaidMembershipReceipt extends AbstractCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			ITest test = new EntelPeruAppTestVerifyPostPaidMembershipReceipt(phoneNumber, verificationCode);
	...
	protected String getCommandName() {
		return "app-entel-peru-verificar-afiliacion-recibo-post-pago";
	}

	@Override
	protected String getErrorCode() {
		return "DST-MI-ENTEL-PERU-006";
	}
