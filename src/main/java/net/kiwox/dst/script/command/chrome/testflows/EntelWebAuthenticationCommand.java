...
import static net.kiwox.dst.script.appium.TestUtils.CLI_EXECUTE_AUTHENTICATION_00_ENTEL_WEB_APP;

public class EntelWebAuthenticationCommand extends AbstractChromeCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			IChromeTest test = new EntelWebAuthenticationTest(phoneNumber, passCode);
	...
	protected String getCommandName() {
		return CLI_EXECUTE_AUTHENTICATION_00_ENTEL_WEB_APP;
	}

	@Override
	protected String getErrorCode() {
		return "DST-ENTEL-WEB-000";
	}
