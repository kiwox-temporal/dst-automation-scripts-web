...
import net.kiwox.dst.script.appium.entel_peru.EntelPeruAppTestVerifyPrePaidRecharge;
import net.kiwox.dst.script.pojo.TestResult;
import org.apache.commons.cli.Option;
import org.apache.commons.cli.Options;

public class EntelPeruAppCommandVerifyPostPaidBenefit extends AbstractCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			ITest test = new EntelPeruAppTestVerifyPostPaidBenefit(phoneNumber, verificationCode);
